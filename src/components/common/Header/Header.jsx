    ...
    <header className="header normal">
      ...
      <div className="header-right-btn-group">
        <a className="app-download" href="/bd/bn/app-download" target="_blank" rel="noopener noreferrer">
          ...
          style={{maskImage:"url(https://img.s628b.com/sb/h5/assets/images/icon-set/index-theme-icon/header-appdownload-icon.svg?v=1763700584552)",
        ...
        >
          ...
          style={{maskImage:"url(https://img.s628b.com/sb/h5/assets/images/icon-set/index-theme-icon/header-customer-icon.svg)",
